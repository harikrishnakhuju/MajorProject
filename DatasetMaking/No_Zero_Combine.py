...
# Define file paths
csv_folder = r"DatasetMaking\output"
combined_file = r'DatasetMaking\RansomwareCSV\Full_No_Zero_combined_features.csv'
...
combined_output_folder = r"DatasetMaking\combined_output"
...
for file_name in os.listdir(csv_folder):
    if file_name.endswith(".csv"):  # Process only CSV files
        ...
        # Move the processed file to the combined_output folder
        shutil.move(file_path, os.path.join(combined_output_folder, file_name))
        print(f"Moved {file_name} to {combined_output_folder}")
